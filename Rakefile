...
task :console do
  ...
  # #maybe a logo?
  # #Select what car you would like to drive
  # #output information about car and class
  # #outputs information about average speed of cars in those classes
  # #Gives option to pick a new car and return
  # #given car certain tracks are only availabe with that cars class
  # #Select which track you would like to drive on
